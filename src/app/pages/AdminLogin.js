...
export default class AdminLogin extends Component {
    ...
    render() {
        ...
        return (_jsx("section", { className: "relative bg-[url('/bg-images/WhoYouAre.png')] bg-cover bg-top-right h-screen min-h-screen bg-no-repeat w-full rounded-0 bg-white lg:overflow-x-hidden overflow-scroll", children: _jsxs("div", { className: "relative z-10 mx-auto max-w-[1280px] w-full h-full px-4 sm:px-6 lg:px-0 py-8 sm:py-16 flex flex-col", children: [_jsxs("div", { className: "flex-1 w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center", children: [_jsxs("div", { className: "w-full flex flex-col gap-6", children: [_jsx(AdminHeader, {}), _jsx(FeaturesList, {})] }), _jsx(LoginForm, { email: email, password: password, remember: remember, loading: loading, error: error, onChange: this.handleInputChange, onRememberChange: this.handleRememberChange, onSubmit: this.handleSubmit })] }), _jsx(AdminFooter, { onBack: this.handleBack })] }) }));
    }
}
