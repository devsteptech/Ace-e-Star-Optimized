                    ...
                    >
                        <div className="w-full grid grid-cols-[70px_1fr_70px] items-center">
                            ...
                            <div className="text-center">
                                ...
                                <div className="mt-2 text-[18px] sm:text-[20px] font-extrabold text-[#111827]">
                                    Guest Name
                                </div>

                                <div className="text-[12px] font-medium text-[#374151] opacity-80">
                                    Guest Relation
                                </div>
                            </div>
