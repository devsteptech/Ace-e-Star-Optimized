        ...
        <div className="w-full max-w-[980px] mx-auto">
            <div className="bg-white border border-[#ececec] rounded-2xl shadow-sm p-6 sm:p-8">
                ...
                <div className="text-[12px] text-[#6b7280] mt-1">
                    Add event information and branding
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input value={eventDate} onChange={(e) => onEventDate(e.target.value)} className={inputClass} />
                    </div>
                    ...
                    <div>
                        ...
                        <input value={expectedGuests} onChange={(e) => onExpectedGuests(e.target.value)} className={inputClass} />
                    </div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <label className="cursor-pointer block w-full rounded-xl border border-[#e5e7eb] bg-white h-[118px] sm:h-[128px]">
                            ...
                            <div className="h-full w-full flex flex-col items-center justify-center text-center gap-2 text-[#6b7280]">
